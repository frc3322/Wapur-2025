...
public class DriveConstants {
  public static final double maxSpeedMetersPerSec = 1.524;
  ...
  public static final double driveMotorReduction = 5.9; // SDS MK4 L2+
  ...
  public static final double turnKp = 3.0645;
