...
public interface ElevatorIO {
    ...
    /**
     * Lets us move the elevator to a specific position with a given velocity
     * 
     * @param PositionInMeters
     * @param VeloctiyInMetersPerSecond
     * @param inputs
     */

     public default void goToPosition(double PositionInMeters, double VeloctiyInMetersPerSecond) {}
