...
/**
 * Module IO implementation for Spark Flex or Spark Max drive motor controller,
 * Spark Max turn motor
 * controller, and duty cycle absolute encoder.
 */
public class ModuleIOSpark implements ModuleIO {
    ...
    public ModuleIOSpark(int module, boolean useSparkMaxForDrive) {
        ...
        driveSpark = useSparkMaxForDrive
        ...
        turnEncoder.setPosition((turnAbsoluteEncoder.getAbsolutePosition().getValueAsDouble() * 2 * Math.PI));
